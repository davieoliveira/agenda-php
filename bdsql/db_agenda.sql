...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03/08/2026 às 17:50
...
INSERT INTO `tbcontatos` (`idContato`, `nomeContato`, `emailContato`, `telefoneContato`, `enderecoContato`, `sexoContato`, `dataNascContato`, `flagFavoritoContato`) VALUES
...
--
ALTER TABLE `tbcontatos`
  MODIFY `idContato` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;
COMMIT;
